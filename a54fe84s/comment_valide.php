...
<?php
	try{
		...
		if(isset($_GET['id']) && $_GET['id']!=null)
		{
			...
			$req = sprintf("select c.* from comment c,produit p $condition AND c.id=%s",GetSQLValueString($_GET['id'], "int",$base));
			...
			$req = sprintf("UPDATE comment SET valide=$valide WHERE id=%s",
