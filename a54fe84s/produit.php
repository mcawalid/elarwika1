...
include("static/secure_sql.php");
	...
	$req = "SELECT p.disponible,p.prix,p.id,p.nom,c.nom as categorie,p.nb_vue from produit p,categorie c where p.id_categorie=c.id $condition order by id DESC";
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
						<div class="row">
							<div class="col-md-7">
								<a href='produit_add.php?cat=<?php echo $id_cat; ?>' class='btn btn-primary'> Ajouter un produit</a>
							</div>
							<div class="col-md-5">
