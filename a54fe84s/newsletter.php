...
include("static/secure_sql.php");
	...
	$req = "SELECT * from newsletter ORDER BY id DESC";
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
						<a href='newsletter_list.php' class='btn btn-primary'> Récuperer tout la liste </a>
						<hr/>
						...
						<table id="datatable" class="table table-striped table-bordered">
							...
							<?php while($resultat = mysqli_fetch_assoc ($selectcle)) { ?>
								<tr>
									<td style="vertical-align: middle;"><?php echo $resultat['email']?></td>
									<td style="vertical-align: middle;"><?php echo $resultat['date']?></td>
									<td style="vertical-align: middle;text-align: center;">
										<a onclick="return(confirm('Etes-vous sûr de vouloir supprimer ce mail ?'));" href='newsletter_supp.php?id=<?php echo $resultat['id'] ?>'><img src='images/supp.png' /></a>
									</td>
								</tr>
							<?php } ?>
						</table>
