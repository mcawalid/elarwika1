...
include("static/secure_sql.php");
	...
	$req = "SELECT email from users ORDER BY id DESC";
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Liste des emails des comptes</h3>
              </div>
            </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
						...
						<textarea rows="15" required="required" class="form-control col-md-7 col-xs-12"><?php while($resultat = mysqli_fetch_assoc ($selectcle)) { 
								echo $resultat['email'].";";
								} ?></textarea>
