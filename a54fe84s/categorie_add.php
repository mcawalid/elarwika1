                ...
                <div class="x_panel">
                  <div class="x_content">
					...
					<?php
						...
						{
							$req = sprintf("INSERT INTO categorie (id,nom,ordre) VALUES (NULL,%s,%s)",
...
function noscript(strCode){
 ...
 return html.html();
					...
					<form method="POST" action="categorie_add.php" class="form-horizontal form-label-left" novalidate>
						  ...
						  <div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input value="0" id="ordre" type="number" name="ordre" data-validate-length-range="1,3" required="required" class="form-control col-md-7 col-xs-12">
							</div>
						  </div>
