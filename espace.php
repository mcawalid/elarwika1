...
if (!isset($_SESSION)) {
  session_start();
	...
	$req = sprintf("SELECT genre FROM user WHERE id=%s",GetSQLValueString($_SESSION['id_vente'],"int",$base));
                                ...
                                <div class="tab-content my-account-tab" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="pills-dashboard" role="tabpanel"
                                        ...
                                        <div class="my-account-dashboard account-wrapper">
                                            <h4 class="account-title">Mon compte</h4>
                                            <div class="welcome-dashboard m-t-30">
												Bienvenu <?php if($user['genre']==0) echo "Mr"; else echo "Mme"; ?> <?php echo $_SESSION['vente_name']?> à votre compte personnel (SITE DU VENTE)<br/><br/>
												Vous pouvez ajouter des <a href="espace_follow.php">produits en favoris</a>, et <a href="espace_commande.php">suivre vos commandes</a>, Ainsi de <a href="espace_comment.php">gérer vos commentaires</a><br/><br/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
